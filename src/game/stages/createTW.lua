...
local function createTW()
    local stage = Stage(100,200,BasicTileset)
    local mapdata = require "src.game.maps.demomap"
    stage:readMapData(mapdata)


    local bg1 = Background("graphics/tilesets/PixelPlatformerSet2v.1.1/Background/background1-1.png")
    local bg2 = Background("graphics/tilesets/PixelPlatformerSet2v.1.1/Background/background4.png")
    local bg3 = Background("graphics/tilesets/PixelPlatformerSet2v.1.1/Background/background5.png")
